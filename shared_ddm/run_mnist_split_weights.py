...
for i in range(no_repeats):
    ...
    path = 'sandbox/two_hidden_layers/pruned/test/'
    ...
    vcl_result = vcl_weights.run_vcl_shared_weights(hidden_size, no_epochs, data_gen,
        coreset.rand_from_batch, coreset_size, batch_size, ml_init, path=path, no_iters=no_iters)
