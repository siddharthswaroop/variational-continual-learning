...
# Random coreset
path = 'model_storage/singlehead_split_coreset/'   # Path where to store files
coreset_size = 40
...
# # Random coreset ONLY (baseline)
# path = 'model_storage/singlehead_split_coreset/baseline_data_and_coreset/'   # Path where to store files
# coreset_size = 40
# vcl_result = vcl.run_vcl_shared_baseline(hidden_size, no_epochs, data_gen,
#     coreset.rand_from_batch, coreset_size, batch_size, path, multi_head, store_weights=store_weights)
#
# # Store accuracies
# np.savez(path + 'test_acc.npz', acc=vcl_result)
